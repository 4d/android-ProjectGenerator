object MustacheConstants {
    ...
    const val TABLENAMES_WITH_MANY_TO_ONE_RELATIONS = "tableNames_with_many_to_one_relations"
    ...
    const val RELATION_NAME_CAP = "relation_name_cap"
    const val RELATIONS_MANY_TO_ONE = "relations_many_to_one"
    const val RELATIONS_ONE_TO_MANY = "relations_one_to_many"
    const val TABLE_HAS_ANY_MANY_TO_ONE_RELATION = "table_has_any_many_to_one_relation"
    ...
    const val HAS_ANY_RELATIONS_ONE_TO_MANY_FOR_LIST = "has_any_relations_one_to_many_for_list"
    const val HAS_ANY_RELATIONS_MANY_TO_ONE_FOR_LIST = "has_any_relations_many_to_one_for_list"
